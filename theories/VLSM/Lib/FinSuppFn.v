...
(**
  ...
  to the type of <<b>> such that only finitely many elements from <<A>> are
  mapped to values other than <<b>>.
*)
...
#[global] Infix "-fin<>" := FinSuppFn (at level 60, right associativity).
