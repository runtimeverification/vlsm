...
Proof.
  ...
  - rewrite 2 filter_cons.
    ...
    by destruct (decide (P a)), (decide (Q a)); [rewrite IHl | ..]; sauto.
Qed.
...
Proof.
  ...
  - by apply NoDup_app; sauto.
  - by rewrite elem_of_app; sauto.
Qed.
...
Proof.
  by intros b; rewrite !elem_of_map_option; sauto.
Qed.
...
Proof.
  by intros b; rewrite !in_map_option; sauto.
Qed.
