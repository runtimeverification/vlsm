...
Proof.
  ...
  - apply equivocators_composition_for_directly_observed_index_incl_full_projection.
    Unshelve.
    2: by intros x Hx; apply elem_of_elements, union_subseteq_r, elem_of_elements.
  ...
  - apply valid_trace_add_default_last in Htr.
    ...
    + apply finite_valid_trace_singleton.
      ...
      * revert Hs; apply VLSM_incl_valid_state.
        ...
        intro; rewrite !elem_of_elements.
        by destruct iom as [im |]; [apply set_union_subseteq_left |].
      * destruct iom as [im |]
        ...
        -- eapply composite_directly_observed_valid; [| done].
           revert Hs; apply VLSM_incl_valid_state.
           apply fixed_equivocation_vlsm_composition_index_incl;
              intro; rewrite !elem_of_elements; apply set_union_subseteq_left.
        -- revert HLim.
...
Proof.
  ...
  case_decide as Hnobserved; [apply empty_subseteq |].
